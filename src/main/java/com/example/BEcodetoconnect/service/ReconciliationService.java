...
public class ReconciliationService {
    ...
    public void save(SwiftMessage swiftMessage) {
        swiftMessageRepository.save(swiftMessage);
    }

    public HashMap<String, List<LedgerTransaction>> reconcileTransactions(List<LedgerTransaction> ledgerTransactions, SwiftMessage swiftMessage) {
